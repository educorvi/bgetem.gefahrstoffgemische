...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_druckbestaeubungspuder_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='druckbestaeubungspuder-view'
        )
        self.assertTrue(view.__name__ == 'druckbestaeubungspuder-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in druckbestaeubungspuder-view'
        # )

    def test_druckbestaeubungspuder_view_not_matching_interface(self):
