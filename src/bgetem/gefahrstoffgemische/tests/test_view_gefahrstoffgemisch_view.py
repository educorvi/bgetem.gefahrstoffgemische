...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_gefahrstoffgemisch_view_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='gefahrstoffgemisch-view'
        )
        self.assertTrue(view.__name__ == 'gefahrstoffgemisch-view')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in gefahrstoffgemisch-view'
        # )

    def test_gefahrstoffgemisch_view_not_matching_interface(self):
